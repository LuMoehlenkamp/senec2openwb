...
private:
  ...
  const std::string mTopicInvPower{"openWB/set/mqtt/pv/2/get/power"};
  const std::string mTopicInvEnergy{"openWB/set/mqtt/pv/2/get/exported "};

  const std::string mTreeElemGridPower{"ENERGY.GUI_GRID_POW"};
  const std::string mTopicGridPower{"openWB/set/mqtt/counter/0/get/power"};
  const std::string mTopicGridImportedEnergy{"openWB/set/mqtt/counter/0/get/imported"};
  const std::string mTopicGridExportedEnergy{"openWB/set/mqtt/counter/0/get/exported"};
  const std::string mTreeElemFreq{"PM1OBJ1.FREQ"};
  const std::string mTopicFrequency{"openWB/set/mqtt/counter/0/get/frequency"};
  const std::string mTreeElemGridPowers{"PM1OBJ1.P_AC"};
  const std::string mTopicGridPowers{"openWB/set/mqtt/counter/0/get/powers"};
  std::array<float, 3> mPowerValues{0.0f, 0.0f, 0.0f};
  const std::string mTreeElemVoltages{"PM1OBJ1.U_AC"};
  const std::string mTopicGridVoltages{"openWB/set/mqtt/counter/0/get/voltages"};
  std::array<float, 3> mVoltageValues{0.0f, 0.0f, 0.0f};
  const std::string mTreeElemCurrents{"PM1OBJ1.I_AC"};
  const std::string mTopicGridCurrents{"openWB/set/mqtt/counter/0/get/currents"};
  std::array<float, 3> mCurrentValues{0.0f, 0.0f, 0.0f};
  const std::string mTopicGridPowerFactor{"openWB/set/mqtt/counter/0/get/power_factors"};
  const std::string mPowerFactorValue{"1.0"};

  const std::string mTreeElemBatteryPower{"ENERGY.GUI_BAT_DATA_POWER"};
  const std::string mTopicBatteryPower{"openWB/set/mqtt/bat/1/get/power"};
  const std::string mTopicBatteryImportedEnergy{"openWB/set/mqtt/bat/1/get/imported"};
  const std::string mTopicBatteryExportedEnergy{"openWB/set/mqtt/bat/1/get/exported"};
  const std::string mTopicBatterySoc{"openWB/set/mqtt/bat/1/get/soc"};
