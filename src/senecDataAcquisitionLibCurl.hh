...
private:
  ...
  std::vector<std::string> mTopicGridPowersVec{"openWB/set/counter/0/get/powers "};
  std::array<float, 3> mPowerValues{0.0f, 0.0f, 0.0f};
  const std::string mTreeElemVoltages{"PM1OBJ1.U_AC"};
  std::vector<std::string> mTopicGridVoltagesVec{"openWB/set/counter/0/get/voltages"};
  std::array<float, 3> mVoltageValues{0.0f, 0.0f, 0.0f};
  const std::string mTreeElemCurrents{"PM1OBJ1.I_AC"};
  std::vector<std::string> mTopicGridCurrentsVec{"openWB/set/counter/0/get/currents"};
  std::array<float, 3> mCurrentValues{0.0f, 0.0f, 0.0f};
  std::vector<std::string> mTopicGridPowerFactorVec{"openWB/set/counter/0/get/power_factors"};
